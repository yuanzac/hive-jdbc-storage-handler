 ...
 */
package com.qubitproducts.hive.config;
...
public class JdbcStorageConfigManagerTest {
    ...
    public void testWithAllRequiredSettingsDefined() {
        ...
        props.put(JdbcStorageConfig.JDBC_URL.getPropertyName(), "jdbc://localhost:3306/qubit");
        ...
        assertThat(jobMap.get(JdbcStorageConfig.JDBC_URL.getPropertyName()), is(equalTo("jdbc://localhost:3306/qubit")));
